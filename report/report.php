        ...
        <section class="erp-details-section" style="padding: 20px; background-color: #f9f9f9;">
            <div class="erp-details-container" style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px;">
                ...
                foreach ($reports as $report) {
                    echo "
                    <div class='feature-block' style='width: 350px; padding: 25px; text-align: center; border-radius: 8px; background-color: #91BDE5; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); font-size: 40px;'>
                        <i class='{$report[2]}' style='font-size: 40px; color: #333;'></i>
                        <a href='{$report[1]}' style='text-decoration: none; color: #333;'>
                            <h3 style='margin-top: 5px; font-size: 32px;'>{$report[0]}</h3>
                        </a>
                    </div>";
                }
                ?>
